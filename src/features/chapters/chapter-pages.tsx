...
const chapterPages = {
  ...
  "linux-networking/interfaces-addresses-and-loopback": chapterPage(() => import("../../components/linux-networking/InterfacesAddressesLoopbackChapter").then(({ InterfacesAddressesLoopbackChapter }) => ({ default: InterfacesAddressesLoopbackChapter }))),
  "linux-networking/subnets-neighbors-and-gateways": chapterPage(() => import("../../components/linux-networking/SubnetsNeighborsGatewaysChapter").then(({ SubnetsNeighborsGatewaysChapter }) => ({ default: SubnetsNeighborsGatewaysChapter }))),
  "linux-networking/routes-and-packet-paths": chapterPage(() => import("../../components/linux-networking/AdvancedLinuxNetworkingChapter").then(({ AdvancedLinuxNetworkingChapter }) => ({ default: ({ learnerCount }) => <AdvancedLinuxNetworkingChapter slug="routes-and-packet-paths" learnerCount={learnerCount} /> }))),
  "linux-networking/sockets-ports-and-tcp": chapterPage(() => import("../../components/linux-networking/AdvancedLinuxNetworkingChapter").then(({ AdvancedLinuxNetworkingChapter }) => ({ default: ({ learnerCount }) => <AdvancedLinuxNetworkingChapter slug="sockets-ports-and-tcp" learnerCount={learnerCount} /> }))),
  "linux-networking/dns-and-service-reachability": chapterPage(() => import("../../components/linux-networking/AdvancedLinuxNetworkingChapter").then(({ AdvancedLinuxNetworkingChapter }) => ({ default: ({ learnerCount }) => <AdvancedLinuxNetworkingChapter slug="dns-and-service-reachability" learnerCount={learnerCount} /> }))),
  "linux-networking/diagnose-a-linux-network": chapterPage(() => import("../../components/linux-networking/AdvancedLinuxNetworkingChapter").then(({ AdvancedLinuxNetworkingChapter }) => ({ default: ({ learnerCount }) => <AdvancedLinuxNetworkingChapter slug="diagnose-a-linux-network" learnerCount={learnerCount} /> }))),
