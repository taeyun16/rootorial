      ...
      <div className="article-layout">
        ...
        <article className="lesson-article">
          ...
          <section className="article-section" id="evidence">
            ...
            <p>{t(
              "각 receipt는 chapter id, schema version, adapter revision, canonical fixture 목록, assertion 수와 deterministic fingerprint를 담습니다. capstone은 일곱 chapter가 정확히 한 번씩 있는지 확인하고, 현재 adapter revision의 canonical evaluator를 재실행해 fingerprint를 비교합니다. 누락, 중복, stale, tampered와 evaluator regression은 서로 다른 실패입니다.",
              "Each receipt carries a chapter id, schema version, adapter revision, canonical fixture list, assertion count, and deterministic fingerprint. The capstone requires exactly one receipt from each of seven chapters, re-runs every canonical evaluator at the current adapter revision, and compares fingerprints. Missing, duplicate, stale, tampered, and evaluator-regression states are distinct failures.",
            )}</p>
