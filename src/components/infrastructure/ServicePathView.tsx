...
import type { ServicePathEvaluation, ServicePathFailureReason } from "../../features/infrastructure/service-discovery";
...
export function ServicePathView({
  ...
  return (
    ...
    >
      ...
      <div className="service-map" role="img" aria-labelledby={`${titleId} ${descriptionId}`}>
