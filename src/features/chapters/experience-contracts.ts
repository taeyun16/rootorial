...
export const chapterExperienceContracts = Object.freeze({
  ...
  "linux-networking/sockets-ports-and-tcp": { interaction: "trace-and-diagnose", primaryVisual: "causal-timeline", linkedEvidence: "process/kernel sequence · queue · recv", status: "implemented", visualizationKey: "tcp-boundary-sequence" },
  "linux-networking/dns-and-service-reachability": { interaction: "trace-and-diagnose", primaryVisual: "causal-timeline", linkedEvidence: "TTL timeline · route · TCP · response", status: "implemented", visualizationKey: "dns-ttl-timeline" },
