              ...
              <div className="admin-question-table-wrap">
                <table className="admin-question-table">
                  ...
                  <tbody>{data.learning.questionStats.map((question) => (
                    <tr key={`${question.curriculumSlug}/${question.chapterSlug}/${question.questionId}`}>
                      <th scope="row"><strong>{question.label}</strong><code>{question.curriculumSlug}/{question.chapterSlug}/{question.questionId}</code></th>
