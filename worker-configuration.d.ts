/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: e9c2424389ddfa9a7651953028c45126)
// Runtime types generated with workerd@1.20260708.1 2026-07-11 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	LEARNING_SESSIONS: DurableObjectNamespace<import("./src/server").LearningSession>;
	LEARNING_PRESENCE: DurableObjectNamespace<import("./src/server").LearningPresence>;
	SYSTEM_EVENTS_QUEUE?: Queue;
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "LearningSession" | "LearningPresence";
	}
	interface E2eEnv {
		DB: D1Database;
		LEARNING_SESSIONS: DurableObjectNamespace<import("./src/server").LearningSession>;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DISCORD_SIGNUP_THREAD_ID" | "DISCORD_QUESTION_THREAD_ID" | "DISCORD_FEEDBACK_THREAD_ID" | "CLERK_PUBLISHABLE_KEY" | "CLERK_SECRET_KEY" | "ROOTORIAL_ADMIN_USER_IDS">> {}
}
